...
using OpenS4L.Network.Message.Event;
using OpenS4L.Network.Message.P2P;
using OpenS4L.Network.Message.Relay;
using OpenS4L.Network.Serializers;
using OpenS4L.Server.Relay.Services;
...
namespace OpenS4L.Server.Relay
{
    internal static class Program
    {
        ...
        {
            var baseDirectory = Environment.GetEnvironmentVariable("OPENS4L_BASEDIR_RELAY");
