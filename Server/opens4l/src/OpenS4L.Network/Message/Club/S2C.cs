...
namespace OpenS4L.Network.Message.Club
{
    [BlubContract]
    ...
    public class ClubStuffListAckMessage : IClubMessage
    {
        [BlubMember(0)]
        [BlubSerializer(typeof(ArrayWithIntPrefixSerializer))]
        public OpenS4L.Network.Data.Chat.ClubMemberDto[] Members { get; set; }
    }
    ...
    public class ClubStuffListAck2Message : IClubMessage
    {
        [BlubMember(0)]
        [BlubSerializer(typeof(ArrayWithIntPrefixSerializer))]
        public OpenS4L.Network.Data.Chat.ClubMember2Dto[] Members { get; set; }
    }
