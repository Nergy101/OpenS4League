...
public class ScnPreviewView : Control
{
    ...
    public static readonly StyledProperty<IReadOnlyList<S4League.Scn.ScnMesh>?> MeshesProperty =
        AvaloniaProperty.Register<ScnPreviewView, IReadOnlyList<S4League.Scn.ScnMesh>?>(nameof(Meshes));
    ...
    public IReadOnlyList<S4League.Scn.ScnMesh>? Meshes
    {
    ...
    private void FitCamera()
    {
        ...
        _camera = ScnRenderer.FitCamera(meshes ?? new List<S4League.Scn.ScnMesh>(), w, h);
    }
    ...
    public override void Render(DrawingContext context)
    {
        ...
        int w = Math.Max(1, (int)Bounds.Width);
        int h = Math.Max(1, (int)Bounds.Height);
        context.FillRectangle(new SolidColorBrush(Color.FromRgb(24, 26, 32)), new Rect(0, 0, w, h));
