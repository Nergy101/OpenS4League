...
import { buildMap } from '../src/MapLoader.js';
...
test('safe-line alpha follows original animation keys', async () => {
  ...
  const result = buildMap(manifest, bytes.buffer.slice(bytes.byteOffset, bytes.byteOffset + bytes.byteLength), new Map(), 's4-map-threejs');
